...
if ($_SERVER["REQUEST_METHOD"] === "POST") {
    ...
    $sql = "UPDATE carousel_data3 SET image_url=?, title=?, subtitle=?, link=? WHERE id=1";
...
// Redirecione de volta para carousel_edit.php
echo '<script>window.location.href = "/ProjetoFecomercio/assets/php/carousel_edit.php";</script>';
exit();
?>