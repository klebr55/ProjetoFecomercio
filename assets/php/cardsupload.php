    ...
    .invisible {
      visibility: hidden;
        ...
        <body>
            ...
            $diretorio = "C:/xampp/htdocs/ProjetoFecomercio/uploadcards/";

            if (isset($_FILES['arquivo'])) {
                $nome_arquivo = $_FILES['arquivo']['name'];
                $diretorio = "/ProjetoFecomercio/uploadcards/";
                ...
                if (isset($_POST['codigo'])) {
                    ...
                    $arquivo_destino = $_SERVER['DOCUMENT_ROOT'] . '/ProjetoFecomercio/uploadcards/' . $nome_arquivo;
                    if (move_uploaded_file($_FILES['arquivo']['tmp_name'], $arquivo_destino)) {
                        ...
                        $sql_code = "UPDATE arquivo2 SET arquivo = '$nome_arquivo', data = NOW() WHERE codigo = $codigo";
            ...
            <p style="font-family: Arial, Helvetica, sans-serif; text-align: center; font-size: 40px; font-weight: bold;"> Fazer Upload da imagem do 1° Card </p>

            <div class="container4" style="transform: translateY(-20%);">
                <form style="border-radius: 1rem; width: 100%; max-width: 45rem; margin-left: 350px; transform: translateY(20%);" action="cardsupload.php" method="POST" enctype="multipart/form-data">
                    ...
                    <input type="submit" class="btn btn-primary" value="Retornar para página de edição do carrossel" style="margin-top: 20px; margin-bottom: 100px;" onclick="window.location.href = 'cards_edit.php';">
                </form>
            </div>

            <p style="font-family: Arial, Helvetica, sans-serif; text-align: center; font-size: 40px; font-weight: bold;"> Fazer Upload da imagem do 2° Card </p>

            <div class="container4">
                <form style="border-radius: 1rem; width: 100%; max-width: 45rem; margin-left: 350px; margin-top: 60px;" action="cardsupload.php" method="POST" enctype="multipart/form-data"> 
                    ...
                    <input type="submit" class="btn btn-primary" value="Retornar para página de edição do carrossel" style="margin-top: 20px;" onclick="window.location.href = 'cards_edit.php';">
                </form>
            </div>


            <p style="font-family: Arial, Helvetica, sans-serif; text-align: center; font-size: 40px; font-weight: bold; margin-top: 60px;"> Fazer Upload da imagem do 3° Card </p>
