                    ...
                    <div class="main-content invisible">
                        ...
                        <div class="panel-wrapper">
                            <div class="panel-head">
                                Editor do Carrossel da Página Inicial
                            </div>
                            <div class="container">
                                <div class="row" style="transform: translateY(-7%);">
                                    <div class="panel-body" style="transform: translateY(20%); margin-left: 0;">
                                        <p style="font-size: 3.5vh; font-family: Arial, Helvetica, sans-serif; font-weight: bold;">Aqui você edita o Carrossel da página inicial.</p> <br>
                                        <p style="font-size: 2.5vh; font-family: Arial, Helvetica, sans-serif; font-weight: bold; margin-top: -40px; margin-bottom: 50px;"> Atenção: Cuidado! Ao alterar o conteúdo do Carrossel, 
                                        ...
                                        URL de Redirecionamento: Aqui você irá colocar o url do site onde estará hospedada a notícia. O link que colocares aqui, será o mesmo que você será redirecionado quando apertar o botão "Saiba Mais" lá no Carrossel.</p>
                                    </div>

                                    <div class="col" style="margin-top: 15vh;">
                                        <p style="font-size: 3vh;">Editar Seção 1 do Carrossel</p>

                                        <button class="btn btn-primary" style="margin-top: 20px; margin-bottom: 10px;" onclick="window.location.href = 'upload.php';">Ir para página de upload de imagens</button>

                                        <p style="margin-top: 10px; font-weight: bold;">Ou insira o URL da Imagem abaixo 🔻</p>

                                        <form action="process_carousel_edit.php" method="post">
                                        ...
                                        <p style="font-size: 3vh; margin-top: 60px;">Editar Seção 2 do Carrossel</p>

                                        <button class="btn btn-primary" style="margin-top: 20px; margin-bottom: 10px;" onclick="window.location.href = 'upload.php';">Ir para página de upload de imagens</button>

                                        <p style="margin-top: 10px; font-weight: bold;">Ou insira o URL da Imagem abaixo 🔻</p>

                                        <form action="process_carousel_edit2.php" method="post">
                                        <div class="form-group">
                                            <label for="image_url">URL da Imagem:</label>
                                            <input type="text" class="form-control" name="image_url" id="image_url">
                                        </div>
                                        ...
                                        <p style="font-size: 3vh; margin-top: 60px;">Editar Seção 3 do Carrossel</p>

                                        <button class="btn btn-primary" style="margin-top: 20px; margin-bottom: 10px;" onclick="window.location.href = 'upload.php';">Ir para página de upload de imagens</button>

                                        <p style="margin-top: 10px; font-weight: bold;">Ou insira o URL da Imagem abaixo 🔻</p>

                                        <form action="process_carousel_edit3.php" method="post">
                                        <div class="form-group">
                                            <label for="image_url">URL da Imagem:</label>
                                            <input type="text" class="form-control" name="image_url" id="image_url">
                                        </div>
